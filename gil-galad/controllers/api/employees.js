...
exports.findEmployees = function(req, res, next) {
	db.query("SELECT * FROM employee where _recStatus='ACTIVE'", function(err, rows) {
...
exports.findOne = function(req, res, next) {
	db.query("SELECT * FROM employee WHERE _id=? AND _recStatus='ACTIVE'", [req.params.id], function(err, rows) {
